...
AI_SERVICE_MAX_RETRIES = int(os.getenv("AI_SERVICE_MAX_RETRIES", "5"))
AI_SERVICE_INITIAL_RETRY_DELAY_SECONDS = float(os.getenv("AI_SERVICE_INITIAL_RETRY_DELAY_SECONDS", "5"))
